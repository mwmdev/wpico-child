...
<main class="front-page">
    ...
    <section class="hero">
        ...
        <h1><?php esc_html_e( 'Global justice, together.', 'c7' ); ?></h1>
        <div class="hero__blur"></div>
        <img class="hero__cover" src="<?php echo esc_url( "$img/c7-cover-en.png" ); ?>" alt="" width="1220" height="870" loading="eager"/>
    </section>
    ...
    <section class="communique">
        ...
        <a class="communique__link" href="<?php echo esc_url( $what_url ); ?>">
            <?php esc_html_e( 'Read more about the C7', 'c7' ); ?>
        </a>
    </section>
    ...
    <section class="communique-banner">
        <div class="communique-banner__content">
            <h2><?php esc_html_e( 'The 2025 C7 Communique is now available', 'c7' ); ?></h2>
            <p><?php esc_html_e( 'Global Justice, Together.', 'c7' ); ?></p>
        ...
        <img class="communique-banner__cover" src="<?php echo esc_url( "$img/c7-cover-en.png" ); ?>" alt="" width="1220" height="870" loading="lazy"/>
    </section>
    ...
    <section class="about">
        ...
        <div class="about__inner">
            ...
            <p><?php esc_html_e( "Through a thoughtful balancing of Government of Canada G7 objectives and international civil society concerns, we've curated a list of thematic priorities and established dedicated working groups to tackle them.", 'c7' ); ?></p>
    ...
    <section class="priorities">
        <div class="priorities__grid">
            <a class="priorities__card" href="<?php echo esc_url( $priorities_url . '#climate-energy-and-environment' ); ?>">
                <img src="<?php echo esc_url( "$img/temp.svg" ); ?>" alt="" width="50" height="50"/>
                <span><?php esc_html_e( 'Climate, Energy & Environment', 'c7' ); ?></span>
            </a>
            <a class="priorities__card" href="<?php echo esc_url( $priorities_url . '#economic-justice' ); ?>">
                <img src="<?php echo esc_url( "$img/scale.svg" ); ?>" alt="" width="50" height="50"/>
                <span><?php esc_html_e( 'Economic Justice', 'c7' ); ?></span>
            </a>
            <a class="priorities__card" href="<?php echo esc_url( $priorities_url . '#humanitarian-action-and-peace' ); ?>">
                <img src="<?php echo esc_url( "$img/peace.svg" ); ?>" alt="" width="50" height="50"/>
                <span><?php esc_html_e( 'Humanitarian Action & Peace', 'c7' ); ?></span>
            </a>
            <a class="priorities__card" href="<?php echo esc_url( $priorities_url . '#sustainable-development' ); ?>">
                <img src="<?php echo esc_url( "$img/growth.svg" ); ?>" alt="" width="50" height="50"/>
                <span><?php esc_html_e( 'Sustainable Development', 'c7' ); ?></span>
            </a>
        </div>
    </section>
    ...
    <section class="info-grid">
        ...
        <img class="info-grid__bg" src="<?php echo esc_url( "$img/mountain.jpg" ); ?>" alt="" loading="lazy"/>
